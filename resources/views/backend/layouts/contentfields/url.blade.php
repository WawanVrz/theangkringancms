    ...
    <div class="form-group">
        ...
        <div class="col-sm-12">
            <input
                ...
                @if(is_array($f['message_error']) && array_key_exists('url',$f['message_error'])) data-msg-url="{{ ucfirst(trans_custom('backend/content.'.$type.'.field_container.'.$index.'.field.'.$i.'.message_error.url', $f['message_error']['url'])) }}" @endif
