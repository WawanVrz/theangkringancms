    ...
    <div class="form-group">
        ...
        <div class="col-sm-12">
            <input
                ...
                @if(is_array($f['message_error']) && array_key_exists('email',$f['message_error'])) data-msg-email="{{ ucfirst(trans_custom('backend/content.'.$type.'.field_container.'.$index.'.field.'.$i.'.message_error.email', $f['message_error']['email'])) }}" @endif
