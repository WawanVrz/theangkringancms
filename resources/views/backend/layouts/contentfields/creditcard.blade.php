    ...
    <div class="form-group">
        ...
        <div class="col-sm-12">
            <input
                ...
                @if(is_array($f['message_error']) && array_key_exists('cc',$f['message_error'])) data-msg-creditcard="{{ ucfirst(trans_custom('backend/content.'.$type.'.field_container.'.$index.'.field.'.$i.'.message_error.cc', $f['message_error']['cc'])) }}" @endif
