...
@section('page_title', ucwords(trans('backend/core.edit_account')) )
...
<div class="content">
    ...
    <div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
        <h6 class="alert-heading text-semibold">
            ...
            Editing a Account takes quite a few steps. Fill out the account's content below to present users relevant information of our website. 
        <br><br>
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">{{ ucwords(trans('backend/core.edit_account')) }}</h5>
        </div>
        ...
        <div class="panel-body">
            ...
            @endif
            <form role="form" action="{{ Route('Account.update', $object->id) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
            {{ csrf_field() }}
            <input type="hidden" name="_method" value="PATCH">
                <fieldset class="content-group">
                        ...
                        <div class="col-lg-10">
                            <select name="role_id" class="selectpicker" required>
                                @foreach($roleData as $data)
                                    @if(($data->id == $object->role_id))
                                        <option selected value="{{ $data->id }}">{{ $data->role }}</option>
                                    @else
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" name="firstname" value="{{ $object->firstname }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-lg-2">Last Name</label>
                        <div class="col-lg-10">
                            <input type="text" class="form-control" name="lastname" value="{{ $object->lastname }}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                        <input type="text" class="form-control validation-valid" data-mask="+99 999 ?999 999 999" id="phone" name="telphone" data-rule-phone="true" data-msg="Phone Number Required" data-msg-phone="Please input valid phone number" value="{{ $object->telphone }}" aria-invalid="false">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-lg-2">Password</label>
                        <div class="col-lg-10">
                        <input type="password" class="form-control validation-valid" id="password" name="password" value="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select class="select-fixed" name="status">
                                <option value="1" {{ ($object->status == '1') ? 'selected="selected"' : '' }}>Yes</option>
                                <option value="0" {{ ($object->status == '0') ? 'selected="selected"' : '' }}>No</option>
                            </select>
                        </div>
                    </div>
                </fieldset>
                <div class="pull-right">
                    ...
                    <button type="submit" name="submit" class="btn btn-primary">Update Account<i class="icon-check position-right"></i></button>
                </div>
           </form>
        </div>
