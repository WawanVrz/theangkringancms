...
<div class="has-detached-right">
    ...
    <div class="container-detached">
        <div class="content-detached">
            ...
            <!-- Sidebars overview -->
            {!! Form::open(['url' => url(env('BACKEND_ROUTE').'/content/update'), 'id' => 'page_form', 'class' => 'form-validate-jquery form-horizontal', 'method' => 'post']) !!}
                            ...
                            <div class="tab-pane" id="tab_featured_video">
                                <div class="featured-video-container">
                                    ...
                                    <div class="featured-video-body">
                                        <div class="external-video-field" style="{{ ($object->data['featured_video_used'] == 'external')? 'display:block;' : 'display:none;' }}">
                                        ...
                                        <div class="internal-video-field input-group" style="{{ ($object->data['featured_video_used'] == 'internal')? 'display:block;' : 'display:none;' }}">
                                            <button 
