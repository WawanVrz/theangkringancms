...
<div class="has-detached-right">
    ...
    <div class="container-detached">
        ...
        <!-- /Info alert -->
            ...
            <!-- Sidebars overview -->
            {!! Form::open(['url' => url(env('BACKEND_ROUTE').'/content/blog/update'), 'files'=>'true', 'id' => 'content_form', 'class' => 'form-validate-jquery form-horizontal', 'method' => 'post']) !!}
            ...
            <input id="c_count" type="hidden" name="count" value="{{ $object->data['count'] }}">
            ...
            <input id="c_layouttemplate" type="hidden" name="layouttemplate" value="{{ $object->data['layouttemplate'] }}">
            ...
            @php
                $select_basic_2_datasource = DB::table('content_flat_category_post')->select('content_id as value','title as text')->where('website_id',$website)->get();
                if(!$select_basic_2_datasource) $select_basic_2_datasource = DB::table('content_flat_category_post')->select('content_id as value','title as text')->where('website_id','0')->get();
                $select_basic_3_datasource = DB::table('content_flat_product')->select('content_id as value','product_name as text')->where('website_id',$website)->get();
                if(!$select_basic_3_datasource) $select_basic_3_datasource = DB::table('content_flat_product')->select('content_id as value','product_name as text')->where('website_id','0')->get();
            @endphp
            
            <input id="select_basic_2_datasource" type="hidden" value="{{ json_encode($select_basic_2_datasource) }}">  
            <input id="select_basic_3_datasource" type="hidden" value="{{ json_encode($select_basic_3_datasource) }}">  
    ...
    <div class="sidebar sidebar-default sidebar-separate">
        <div class="sidebar-content">
                        ...
                        <ul class="navigation navigation-alt navigation-accordion">
                            <li>
                                <div style="padding: 10px 30px;">
                                    <input type="radio" id="layoutID1" name="layouttemplate" class="radio-control-primary" value="rectangle" {!! ($object->data['layouttemplate'] == 'rectangle') ? 'checked="checked"' : '' !!}><span style="padding: 10px 10px;">Full Rectangle</span>
                                </div>
                                <div style="padding: 10px 30px;">
                                    <input type="radio" id="layoutID2" name="layouttemplate" class="radio-control-primary" value="square" {!! ($object->data['layouttemplate'] == 'square') ? 'checked="checked"' : '' !!}><span style="padding: 10px 10px;">Square</span>
                                </div>
                                <div style="padding: 10px 30px;">
                                    <input type="radio" id="layoutID3" name="layouttemplate" class="radio-control-primary" value="rectangle-v" {!! ($object->data['layouttemplate'] == 'rectangle-v') ? 'checked="checked"' : '' !!}><span style="padding: 10px 10px;">Vertical Rectangle</span>
                                </div>
                                <div style="padding: 10px 30px;">
                                    <input type="radio" id="layoutID4" name="layouttemplate" class="radio-control-primary" value="rectangle-2" {!! ($object->data['layouttemplate'] == 'rectangle-2') ? 'checked="checked"' : '' !!}><span style="padding: 10px 10px;">Horizontal Rectangle</span>
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="sidebar-category">
                ...
                <div class="category-content no-padding" style="min-height: auto;">
                    <ul class="navigation navigation-alt navigation-accordion">
                        <li>
                            @foreach($bogcategoryused as $objcdata)
                                <a class="publish-attribute">
                                    <i class="icon-info22"></i> 
                                    {{ $objcdata->title }}
                                </a>
            ...
            <div class="sidebar-category">
                <div class="category-title">
                    <span>Product Related List</span>
                    <ul class="icons-list">
                        <li><a href="#" data-action="collapse"></a></li>
                    </ul>
                </div>
                ...
                <div class="category-content no-padding" style="min-height: auto;">
                    <ul class="navigation navigation-alt navigation-accordion">
                        <li>
                            @foreach($productused as $objpdata)
                                <a class="publish-attribute">
                                    <i class="icon-info22"></i> 
                                    {{ $objpdata->product_name }}
                                </a>
                            @endforeach
                        </li>
                    </ul>
