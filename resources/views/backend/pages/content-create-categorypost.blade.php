...
<div class="has-detached-right">
    ...
    <div class="container-detached">
        <div class="content-detached">
            ...
            <!-- Sidebars overview -->
            {!! Form::open(['url' => url(env('BACKEND_ROUTE').'/content/blog/category/store?content_type='.$type), 'id' => 'content_form', 'class' => 'form-validate-jquery form-horizontal', 'method' => 'post']) !!}
