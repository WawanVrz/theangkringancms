...
<div class="has-detached-right">
    ...
    <div class="container-detached">
        <div class="content-detached">
            ...
            <!-- Sidebars overview -->
            {!! Form::open(['url' => url(env('BACKEND_ROUTE').'/content/update'), 'files'=>'true', 'id' => 'content_form', 'class' => 'form-validate-jquery form-horizontal', 'method' => 'post']) !!}
            ...
            <input id="c_order" type="hidden" name="order" value="{{ $object->data['order'] }}">
                        ...
                        <ul class="navigation navigation-alt navigation-accordion">
                            ...
                            <li>
                                <a class="publish-attribute">
                                    ...
                                    <span id="content_publish_time" data-text="{{ ucwords(trans('backend/core.immediately')) }}" data-val="{{ ($object->data['publish_time'] == 0) ? '0' : '1' }}">{{ ($object->data['publish_time'] == 0) ? ucwords(trans('backend/core.immediately')) : date('M d, Y H:i',strtotime($object->data['publish_time'])) }}</span>
                                </a>
                                <div id="content_publish_time_container" style="display:none;">
                                    <div class="radio">
                                        <label>
                                            <input id="radio_publish_default" type="radio" name="stacked-radio-left" class="styled publish-default" {{ ($object->data['publish_time'] == 0) ? 'checked="checked"' : '' }}>
                                            {{ ucwords(trans('backend/core.immediately')) }}
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input id="radio_publish_date" type="radio" name="stacked-radio-left" class="styled" {{ ($object->data['publish_time'] != 0) ? 'checked="checked"' : '' }}>
                                            {{ ucwords(trans('backend/core.set_date_time')) }}
                                            <div class="input-group date-time-container" {{ ($object->data['publish_time'] == 0) ? 'style="display:none;"' : '' }}>
                                                <span class="input-group-addon"><i class="icon-calendar3"></i></span>
                                                <input type="text" class="form-control" id="publish_time_picker"  {!! ($object->data['publish_time'] != 0) ? 'value="'.date('M d, Y H:i',strtotime($object->data['publish_time'])).'"' : '' !!}>
                                            </div>
                                        </label>
                                    </div>
                        ...
                        <ul class="navigation navigation-alt navigation-accordion">
                            ...
                            <li>
                                <a>
                                    ...
                                    <select id="content_template_selector" class="bootstrap-select" data-width="100%" style="display:none;">
                                        ...
                                        <option class="text-size-small" value="{{ $pt['code'] }}" {{ ($pt['code'] == $object->data['template']) ? 'selected="selected"' : '' }}>{{ ucwords($pt['name']) }}</option>
                                        @endforeach
                                    </select>
                                </a>
                            </li>
                            ...
                            <li>
                                <a>
                                    ...
                                    <input id="content_order_field" type="number" class="form-control"  min="0" value="{{ $object->data['order'] }}" style="width:65px; text-align: center; padding-right: 1px;">
                                </a>
                            </li>
                        </ul>
                    </div>
