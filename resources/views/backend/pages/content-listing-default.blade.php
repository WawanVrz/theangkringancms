...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">{{ ucwords(trans('backend/core.content')) }} - Page</h5>
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="text-right">
                <a href="{{ url(env('BACKEND_ROUTE').'/content/create?content_type=page') }}" class="btn btn-success"><i class="icon-file-plus position-left"></i> Add New Page</a>
            </div>
        </div>
        ...
        <table class="table datatable-basic">
            ...
            <tr>
                ...
                <td class="text-center"><a href="<?php echo url("page/".$o->slug) ?>" target="_blank">{{ $o->slug }}</a></td>
                @if($o->status == '1')
                ...
                @endif
                <td class="text-center">{{ ucwords($o->template) }}</td>
                    ...
                    <ul class="icons-list">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a href="{{ url(env('BACKEND_ROUTE').'/content/edit?content_type=page&id='.$o->content_id.'&website=0') }}"><i class="icon-pencil"></i> Edit</a></li>
                                <li><a href="{{ url(env('BACKEND_ROUTE').'/content/delete/'.$o->content_id) }}" class="delete-page"><i class="icon-trash"></i> Delete</a></li>
                            </ul>
                        </li>
                    </ul>
                </td>
