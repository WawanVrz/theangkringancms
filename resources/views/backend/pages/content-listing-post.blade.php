...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">{{ ucwords(trans('backend/core.content')) }} - Blogs Post</h5>
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="text-right">
                <a href="{{ url(env('BACKEND_ROUTE').'/content/blog/create?content_type=post') }}" class="btn btn-success"><i class="icon-file-plus position-left"></i> Add New Page</a>
            </div>
        </div>
        ...
        <table class="table datatable-basic">
            ...
            <tr>
                ...
                <td class="text-center"><a href="<?php echo url($o->slug) ?>" target="_blank">{{ $o->slug }}</a></td>
                @if($o->status == '1')
                ...
                @endif
                <td class="text-center">{{ ucwords($o->viewer) }} Views</td>
                    ...
                    <ul class="icons-list">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a href="{{ url(env('BACKEND_ROUTE').'/content/blog/edit?content_type=post&id='.$o->content_id.'&website=0') }}"><i class="icon-pencil"></i> Edit</a></li>
                                <li><a href="{{ url(env('BACKEND_ROUTE').'/content/blog/delete/'.$o->content_id) }}" class="delete-page"><i class="icon-trash"></i> Delete</a></li>
                            </ul>
                        </li>
                    </ul>
                </td>
