...
@section('page_submodule_url', url(env('BACKEND_ROUTE').'/content/blog/listing?content_type='.$type) ) 
...
<div class="has-detached-right">
    ...
    <div class="container-detached">
        <div class="content-detached">
            ...
            <!-- Sidebars overview -->
            {!! Form::open(['url' => url(env('BACKEND_ROUTE').'/content/blog/store?content_type='.$type), 'id' => 'content_form', 'class' => 'form-validate-jquery form-horizontal', 'method' => 'post']) !!}
            ...
            <input id="c_count" type="hidden" name="count" value=0>
            <input id="website_id" type="hidden" name="website_id" value="0">
            <input id="baseurl" type="hidden" value="{{ url('') }}">
            <input id="c_layouttemplate" type="hidden" name="layouttemplate" value="rectangle">

            @php
                $select_basic_2_datasource = DB::table('content_flat_category_post')->select('content_id as value','title as text')->get();
                $select_basic_3_datasource = DB::table('content_flat_product')->select('content_id as value','product_name as text')->where('website_id','0')->get();
            @endphp
                        ...
                        <ul class="navigation navigation-alt navigation-accordion">
                            <li>
                                <div style="padding: 10px 30px;">
                                    <input type="radio" id="layoutID1" name="layouttemplate" class="radio-control-primary" value="rectangle"><span style="padding: 10px 10px;">Full Rectangle</span>
                                </div>
                                <div style="padding: 10px 30px;">
                                    <input type="radio" id="layoutID2" name="layouttemplate" class="radio-control-primary" value="square"><span style="padding: 10px 10px;">Square</span>
                                </div>
                                <div style="padding: 10px 30px;">
                                    <input type="radio" id="layoutID3" name="layouttemplate" class="radio-control-primary" value="rectangle-v"><span style="padding: 10px 10px;">Vertical Rectangle</span>
                                </div>
                                <div style="padding: 10px 30px;">
                                    <input type="radio" id="layoutID4" name="layouttemplate" class="radio-control-primary" value="rectangle-2"><span style="padding: 10px 10px;">Horizontal Rectangle</span>
                                </div>
                            </li>
                        </ul>
                    </div>
