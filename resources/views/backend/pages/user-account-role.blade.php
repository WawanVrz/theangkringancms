...
<div class="content">
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            ...
            <div class="col-lg-6">
                 {!! Form::open(['url' => url(env('BACKEND_ROUTE').'/user/role/store'), 'class' => 'form-horizontal', 'method' => 'post']) !!}
                    <fieldset class="content-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" name="namerole" placeholder="Name Of Role" required>
                            </div>
                        </div>                       
                    </fieldset>
                    <div class="pull-left"> 
                    ...
                    <div class="pull-right">
                        <button type="submit" class="btn btn-primary">Add <i class="icon-check position-right"></i></button>
                    </div>
                {!! Form::close() !!}
            </div>
            <div class="col-lg-6">
